...
export default async function HomePage() {
  const [featuredDjs, featuredEvents, featuredMixes] = await Promise.all([
    getFeaturedDJs(),
    getFeaturedEvents(),
    getFeaturedMixes(),
  ]);
      ...
      <main className="pb-20">
        ...
        <section className="bg-card/50 border-y border-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold">Featured Mixes</h2>
                <p className="text-muted-foreground mt-1">Hot mixes from our DJs</p>
              </div>
              <Link href="/mixes">
                <Button variant="ghost" className="hidden sm:flex">
                  View All <ArrowRight className="w-4 h-4 ml-2" />
            ...
            {featuredMixes.length > 0 ? (
              ...
              <p className="text-center text-muted-foreground py-12">No featured mixes yet.</p>
            )}
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-1">Don’t miss these special nights</p>
            </div>
            <Link href="/events">
              <Button variant="ghost" className="hidden sm:flex">
                View All <ArrowRight className="w-4 h-4 ml-2" />
          ...
          {featuredEvents.length > 0 ? (
            ...
            <p className="text-center text-muted-foreground py-12">No featured events at the moment.</p>
          )}
        </section>
      </main>
