...
export default function EditEventPage({ djs, event }: EventFormProps) {
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="venueName" name="venueName" required defaultValue={event.venueName} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="venueAddress">Address</Label>
            <Input id="venueAddress" name="venueAddress" required defaultValue={event.venueAddress} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="venueCity">City</Label>
            <Input id="venueCity" name="venueCity" required defaultValue={event.venueCity} />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input id="date" name="date" type="datetime-local" required defaultValue={event.date} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="doors">Doors Open</Label>
              <Input id="doors" name="doors" type="datetime-local" required defaultValue={event.doors} />
            </div>
          </div>
        </CardContent>
      </Card>
