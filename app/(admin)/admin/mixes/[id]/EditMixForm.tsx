...
export default function EditMixForm({
  ...
  async function handleSubmit(formData: FormData) {
    setLoading(true);
    const result = await updateMix(mix._id, formData);
  ...
  async function handleDelete() {
    ...
    setDeleting(true);
    const result = await deleteMix(mix._id);
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label>Title</Label>
              <Input name="title" defaultValue={mix.title} required />
            </div>
            <div className="space-y-2">
              <Label>Slug</Label>
              <Input name="slug" defaultValue={mix.slug} required />
            </div>
            <div className="space-y-2">
              <Label>DJ</Label>
              <select
            ...
            <div className="space-y-2">
              <Label>Genre</Label>
              <Input name="genre" defaultValue={mix.genre} required />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                type="date"
                name="releaseDate"
                defaultValue={new Date(mix.releaseDate).toISOString().split("T")[0]}
                required
              />
            </div>
